...
> **Статус: будущая гипотеза, не применяется.**
>
> На текущей фазе разработки VibeFly бесплатен для всех пользователей.
> Тарифов, оплат и cloud control plane пока нет. Этот документ описывает
> возможную модель монетизации **после** того как продукт стабилизируется
> и наберёт аудиторию. Числа и тарифы могут поменяться в любую сторону.
